...
class COCOEvaluator(DatasetEvaluator):
    ...
    def __init__(self, dataset_name, distributed, output_dir=None):
        ...
        self._output_dir = output_dir  #'/root/emtk_seeds/ckpt/coco/emtk_gfsod_novel/tfa-like/10shot_seed0/inference'
...
#     out_file = open('/root/emtk/Exps/COCO_PR/pkls/30shot_prec.pkl','wb')  #(10, 101, 80, 4, 3)
#     pickle.dump(coco_eval.eval['precision'],out_file)

#     out_file = open('/root/emtk/Exps/COCO_PR/pkls/30shot_rec.pkl','wb')  #(10, 101, 80, 4, 3)
#     pickle.dump(coco_eval.eval['recall'],out_file)

#     out_file = open('/root/emtk/Exps/COCO_PR/pkls/30shot_scores.pkl','wb')  #(10, 101, 80, 4, 3)
#     pickle.dump(coco_eval.eval['scores'],out_file)
#     x = np.arange(0.0, 1.01, 0.01)
#     precision = np.mean(precisions[0, :, :, 0, -1], 1)
#     plt.plot(x, precision, label='30-shot', linestyle='-.', marker='*', markevery=5, color='black')
#     plt.savefig('/root/emtk/Exps/COCO_PR/PR_figs/30shot_PR.png')
    return coco_eval
