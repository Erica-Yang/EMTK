...
#     out_file = open('/root/MFDC/Exps/COCO_PR/pkls/30shot_prec.pkl','wb')  #(10, 101, 80, 4, 3)
#     pickle.dump(coco_eval.eval['precision'],out_file)

#     out_file = open('/root/MFDC/Exps/COCO_PR/pkls/30shot_rec.pkl','wb')  #(10, 101, 80, 4, 3)
#     pickle.dump(coco_eval.eval['recall'],out_file)

#     out_file = open('/root/MFDC/Exps/COCO_PR/pkls/30shot_scores.pkl','wb')  #(10, 101, 80, 4, 3)
...
#     plt.savefig('/root/MFDC/Exps/COCO_PR/PR_figs/30shot_PR.png')
    return coco_eval
