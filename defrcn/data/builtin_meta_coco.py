...
# COCO_CATEGORIES = [
#     {"color": [220, 20, 60], "isthing": 1, "id": 1, "name": "coal miner"},
#     {"color": [119, 11, 32], "isthing": 1, "id": 2, "name": "safety helmet"},
#     {"color": [0, 0, 142], "isthing": 1, "id": 3, "name": "towline"},
#     {"color": [0, 0, 230], "isthing": 1, "id": 4, "name": "hydraulic support guard plate"},
#     {"color": [106, 0, 228], "isthing": 1, "id": 5, "name": "large coal"},
# ]
