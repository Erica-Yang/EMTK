...
def register_all_coco(root="datasets"):
    ...
    METASPLITS = [
        ...
        ("coBa_coal_test_all", "coco/trainval2014", "cocosplit/datasplit/5k_cocoBase_ForeignTest.json"),
        ("coBa_foreign_test_all", "coco/trainval2014", "cocosplit/datasplit/5k_cocoBaseCoalTest.json"),
