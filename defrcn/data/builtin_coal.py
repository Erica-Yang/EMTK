...
def register_all_coco(root="datasets"):
    ...
    METASPLITS = [
        ...
        ("coco14_trainval_all2", "coal/train", "coal/train_annotations_without_background.json"),
        ("coco14_test_all_2", "coal/valid", "coal/valid_annotations_without_background.json"),
        ...
        ("coal_test_all", "coal/valid", "coal/instances_valCoal_all_new_p20.json"),
    ]
