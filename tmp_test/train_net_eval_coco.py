...
if __name__ == "__main__":
    ...
    # args.config_file = "/root/emtk/configs/coco/emtk_gfsod_novel_30shot_seed0.yaml"
    # args.config_file = "configs/coco/emtk_gfsod_novel_1shot_seed0.yaml"
    args.config_file = "configs/coal/emtk_gfsod_novel_1shot_seed0.yaml"
    args.num_gpus = 1
    args.eval_only = True
    launch(
        main,
