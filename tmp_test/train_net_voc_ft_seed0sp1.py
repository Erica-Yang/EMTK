...
if __name__ == "__main__":
    ...
    # args.config_file = "/root/emtk/configs/coco/base.yaml"
    args.config_file = "configs/voc/emtk_gfsod_novel1_1shot_seed0.yaml"
    # args.config_file = "configs/voc/emtk_gfsod_novel1_3shot_seed0.yaml"
    # args.config_file = "configs/voc/emtk_gfsod_novel1_10shot_seed0.yaml"
    # args.config_file = "/root/emtk/configs/coco/emtk_gfsod_novel_2shot_seed0.yaml"
    # args.num_gpus = 1
    args.num_gpus = 2
    # args.eval_only = True
    launch(
