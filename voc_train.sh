...
do
    ...
    do
        ...
        CONFIG_PATH=configs/voc/emtk_gfsod_novel${SPLIT_ID}_${shot}shot_seed${seed}.yaml
        OUTPUT_DIR=${SAVE_DIR}/emtk_gfsod_novel${SPLIT_ID}/tfa-like/${shot}shot_seed${seed}
