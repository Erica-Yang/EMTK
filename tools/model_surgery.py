...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='coal', choices=['voc', 'coal', 'coco'])
    parser.add_argument('--src-path', type=str, default='/root/emtk_coal/ckpt/coco/base/model_final.pth', help='Path to the main checkpoint')
    parser.add_argument('--save-dir', type=str, default='/root/emtk_coal/ckpt/coco/base', help='Save directory')
    parser.add_argument('--method', choices=['remove', 'randinit'], default= 'randinit',
